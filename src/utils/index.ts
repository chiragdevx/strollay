 ...
 * @return {object}
 */
export const parseOptions = function (options: any) {
 ...
 */
export const findIndex = function (array: any, cb: any) {
 ...
 * @returns {number} index
 */
export const findArrayIndex = function (array: any, searchArray: any, cb: any) {
 ...
 * @return {Object}
 */
export const parseContent = (html: any) => {
...
export const parallaxHandler = function () {
  let parallaxItems: any = document.querySelectorAll(".parallax");
 ...
 */
export const videoHandler = (e: any) => {
  e.stopPropagation();
  e.preventDefault();
 ...
 */
export const getCartCount = (cartItems: any) => {
  let total = 0;
